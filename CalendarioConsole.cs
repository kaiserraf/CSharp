...
namespace calendario
{
    class Program
    {
            ...
            string[] mesesAparecer =
        {
            ...
            "Novembro",
            "Dezembro"
        };  // meses do ano -> pedi pro gpt pq tava com preguiça de escrever tudo
            ...
            Console.WriteLine("====================");
            Console.WriteLine(mesesAparecer[mes - 1]); // mostra o nome do mes (mes -1 pq o array começa do 0)
